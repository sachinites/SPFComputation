...
build_linear_topo(){
    ...
    node_t *R0 = create_new_node("R0");
    node_t *R1 = create_new_node("R1");
    node_t *R2 = create_new_node("R2");
    ...
    insert_edge_between_2_nodes(R0_R1_edge, R0, R1);
    insert_edge_between_2_nodes(R1_R2_edge, R1, R2);
